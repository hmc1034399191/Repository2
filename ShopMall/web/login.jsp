...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="res/static/css/main2.css">
...
<div class="content content-nav-base  login-content">
    ...
    <div class="login-bg">
        <div class="login-cont w1200">
            <div class="form-box">
                <form class="layui-form" action="IsloginServlet" method="post">
                    <legend>
                        <img src="/upload/${sessionScope.imgpath}" id="img1">
                        <input type="file" name="file2" id="file1" lay-verify="required">
                    </legend>
