                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline iphone">
                            <div class="layui-input-inline">
                                ...
                                <input type="tel" name="u_name" placeholder="请输入用户名" lay-verify="username"
                        ...
                        <div class="layui-inline iphone">
                            <div class="layui-input-inline">
                                <i class="layui-icon layui-icon-username iphone-icon"></i>
                                <input type="tel" name="u_usernum" lay-verify="usernum" placeholder="请输入账号"
                                       autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline iphone">
                            <div class="layui-input-inline">
                                ...
                                <input type="password" name="u_pwd" id="pwd" lay-verify="pass" placeholder="请输入密码"
                                       autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline iphone">
                            <div class="layui-input-inline">
                                <i class="layui-icon layui-icon-password iphone-icon"></i>
                                <input type="password" name="u_pwd" lay-verify="expass" placeholder="确认密码"
                                       autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline iphone">
                            <div class="layui-input-inline">
                                ...
                                <input type="text" name="u_sex" lay-verify="issex" placeholder="请输入性别"
                                       autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline iphone">
                        ...
                        <div class="layui-inline iphone">
                            <div class="layui-input-inline">
                                ...
                                <input type="text" name="u_adds" placeholder="请输入地址" autocomplete="off"
                                       class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline iphone">
                            <div class="layui-input-inline">
                                ...
                                <input type="text" name="u_emall" placeholder="请输入邮箱" autocomplete="off"
                                       class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline veri-code">
                            <div class="layui-input-inline">
                                ...
                                <input id="pnum" type="text" name="pnum" lay-verify="isvercode" placeholder="请输入验证码"
                                       autocomplete="off" class="layui-input" onblur="mya()">
