    ...
    <div class="data-cont-wrap w1200">
        ...
        <div class="product-intro layui-clear">
            <div class="preview-wrap">
                <a href="javascript:;"><img src="${sessionScope.commodityBeans.c_imag}"></a>
            </div>
            <div class="itemInfo-wrap">
                <div class="itemInfo">
                    <div class="title">
                        <h4>${sessionScope.commodityBeans.c_name}</h4>
                        <span><i class="layui-icon layui-icon-rate-solid"></i>收藏</span>
                    </div>
                    <div class="summary">
                        <p class="reference"><span>参考价</span> <del>￥${sessionScope.commodityBeans.c_proce}</del></p>
                        <p class="activity"><span>活动价</span><strong class="price"><i>￥</i>9.00</strong></p>
                        <p class="address-box"><span>剩&nbsp;&nbsp;&nbsp;&nbsp;余</span><strong class="address">${sessionScope.commodityBeans.c_count}</strong></p>
                    </div>
                    ...
                    <div class="choose-btns">
                        <button class="layui-btn layui-btn-primary purchase-btn" type="submit"><a href="" class="a1">立刻购买</a></button>
                        <button class="layui-btn  layui-btn-danger car-btn"><i class="layui-icon layui-icon-cart-simple"></i><a href="ShopCatServlet?c_id=${sessionScope.commodityBeans.c_id}" class="a2">加入购物车</a></button>
                    </div>
                </div>
            </div>
        </div>
